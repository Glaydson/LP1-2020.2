...
public class Switch {
	...
	public static void main(String[] args) {
		...
		// CTRL + SHIFT + O (letra O) = Organiza os imports (tenta importar pacotes ausentes)
		
		// Inicializa o scanner
		Scanner entrada = new Scanner(System.in);

		int nota = 0, totalNotas = 0;     // Inicializa variáveis
		...
		System.out.printf("Foram lidas %d notas", totalNotas);
