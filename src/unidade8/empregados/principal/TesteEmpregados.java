...
public class TesteEmpregados {
	...
	public static void main(String[] args) {
		...
		EmpregadoComissionado empregado1 = 
				new EmpregadoComissionado("Suzana", "Jones", "222.222.222-22", 10000, .06);
		...
		EmpregadoComissionadoComSalarioBase empregado2 = 
				new EmpregadoComissionadoComSalarioBase("Roberto", "Lima",
